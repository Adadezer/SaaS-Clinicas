...
const AppointmentsChart = ({
  ...
  // Criar os dados para o gráfico, aqui ele pega os agendamentos e o faturamento(revenue) de cada dia (chartDays)
  // Se não houver dados para um dia, ele coloca 0
  // Isso garante que o gráfico sempre terá 21 dias, mesmo que alguns dias não tenham agendamentos ou faturamento
