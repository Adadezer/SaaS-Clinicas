...
export const getAvailableTimes = actionClient
  ...
  .action(async ({ parsedInput }) => {
    ...
    // Verificar de o médico tem diponibilidade para o dia
    ...
    const doctorTimeSlots = timeSlots.filter((timeSlot) => {
      // time = 14:00:00.
      // Se o intervalo de horas é das 14 às 17 horas, terei todos os horários entre 14h e 17h de meia em meia hora
      const date = dayjs()
        .utc()
